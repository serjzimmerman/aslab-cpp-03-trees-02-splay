...
def generate_normal(p_config: dict, p_old_idx: int, p_test_fmt: str = 'normal{}.dat', p_ans_fmt: str = 'normal{}.dat.ans') -> int:
    ...
    for i in range(normal_dict['number']):
        ...
        save_test(p_config['output_path'], sample, requests, p_old_idx, p_test_fmt, p_ans_fmt)

        p_old_idx += 1
    return p_old_idx


def generate_uniform(p_config: dict, p_old_idx: int, p_test_fmt: str = 'uniform{}.dat', p_ans_fmt: str = 'uniform{}.dat.ans') -> int:
...
def generate_triangle(p_config: dict, p_old_idx: int, p_test_fmt: str = 'triangle{}.dat', p_ans_fmt: str = 'triangle{}.dat.ans') -> int:
