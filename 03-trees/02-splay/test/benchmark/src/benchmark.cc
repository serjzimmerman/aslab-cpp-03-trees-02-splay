...
int main(int argc, char *argv[]) {
  ...
  desc.add_options()("help,h", "Print this help message")("compare,c", "Compare with std::set")(
...
#ifdef BOOST_FOUND__
  if (compare) {
    std::cout << (my_set_ans == set_ans ? "Outputs match with std::set" : "Outputs do not match with std::set") << "\n";
  }
